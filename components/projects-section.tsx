        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <BackgroundGradient className="rounded-[22px] overflow-hidden bg-card hover:shadow-lg transition-all group animate-in fade-in slide-in-from-bottom duration-700 hover:-translate-1">
            ...
            <div className="p-6">
              ...
              <p className="text-muted-foreground mb-4">
                ...
                Features include product listings, cart functionality, and user
                authentication.
              </p>
          ...
          <BackgroundGradient className="rounded-[22px] overflow-hidden bg-card hover:shadow-lg transition-all group animate-in fade-in slide-in-from-bottom duration-700 hover:-translate-1">
            ...
            <div className="p-6">
              ...
              <p className="text-muted-foreground mb-4">
                A productivity app that helps users organize tasks and track
                progress. Includes features like task categories, due dates, and
                progress tracking.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                <Badge
          ...
          <BackgroundGradient className="rounded-[22px] overflow-hidden bg-card hover:shadow-lg transition-all group animate-in fade-in slide-in-from-bottom duration-700 hover:-translate-1">
            ...
            <div className="p-6">
              ...
              <p className="text-muted-foreground mb-4">
                A weather application that provides real-time weather data and
                forecasts. Users can search for locations and view detailed
                weather information.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                <Badge
