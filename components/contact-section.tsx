              ...
              <div className="animate-in fade-in slide-in-from-left duration-700">
                ...
                <div className="space-y-4">
                  <div className="flex items-center hover:translate-x-1 transition-transform">
                    ...
                    <span className="text-muted-foreground">+92 3026889246</span>
                  </div>
                  <div className="flex items-center hover:translate-x-1 transition-transform">
                    ...
                    <span className="text-muted-foreground">cnstatus310@gmail.com</span>
                  </div>
                  <div className="flex items-center hover:translate-x-1 transition-transform">
                    ...
                    <span className="text-muted-foreground">Khudian Khas, Kasur, Pakistan</span>
                  </div>
                </div>
                <div className="mt-8">
